<?php
    ...
    */
    send_instant_message($from,$message);
    ...
    */
    ...
    $spasi = strpos ($message," ");
    if ($spasi >0)
      $mymessage = substr($message,0,$spasi);
    else $mymessage = $message;
    $perintah = strtoupper($mymessage);
    ...
    if ($perintah == "DOMAIN"){
        ...
        $m .= ".WEB.ID: 55rb\r\n";
        $m .= ".ASIA: 30rb\r\n\n";
        $m .= "selengkapnya di bestariwebhost.com";
    } elseif ($perintah == "HELP"){
        $m  = "Daftar Perintah:\r\n";
        $m .= "DOMAIN\r\nHOSTING\r\nHELP";
    } elseif  ($perintah == "HOSTING"){
        $m  = "Harga Hosting per thn:\r\n";
        $m .= "Merbabu(50mb): 12rb\r\n";
        $m .= "Ciremai(200mb): 60rb\r\n";
        $m .= "Merapi(500mb): 130rb\r\n";
        $m .= "Bromo(2gb+gratis domain): 500rb\r\n\n";
        $m .= "Selengkapnya di bestariwebhost.com";
 
    } else {
      $m = "Terimakasih, Pesan telah kami terima. ".$perintah." Tidak terdaftar";  
    }
    $f = "+6281219049114";
    $s = "true";
    ...
    */
    ...
    {
    if($_GET['task'] === 'result' AND $_GET['secret']=== '1225')
    {
